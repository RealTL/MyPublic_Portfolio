    ...
    describe('Proposal creation', () => {
        ...
        describe('Failure', () => {
            it('rejects invalid amount - not enough funds in contract to process', async () => {
                await expect(dao.connect(investor1).createProposal('Proposal 1', ether(10000), recipient.address)).to.be.reverted;
            });
    ...
    describe('Governance', () => {
        ...
        describe('Failure', () => {    
            ...
            it('rejects proposal if already finalized.', async () => { 
                ...
                // try to finalize again.  It should fail with transaction already finalized
                await expect(dao.connect(investor1).finalizeProposal(1)).to.be.reverted;
            }); 
